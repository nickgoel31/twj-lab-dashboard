...
const PricingPreview = ({ pricingData }: PricingPreviewProps) => {
  ...
  // Safely get current plans, fallback if empty
  const currentCategory = pricingData[activeTab] || { plans: [] };

  return (
    <div className="w-full flex flex-col items-center">
      
      {/* Category Tabs (Simulating the live site switcher) */}
        ...
        {currentCategory.plans.map((plan) => (
          ...
          >
            ...
            <div className="flex-1 space-y-3 mb-6">
                ...
                {/* Not Included Features (Optional Display) */}
                {plan.featuresNotIncluded?.map((feat, i) => (
